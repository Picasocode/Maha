...
attack_data = X_test.sample(n=10, random_state=42).copy()
attack_data['dst_bytes'] = np.random.randint(1000, 10000, size=10)
attack_data['src_bytes'] = np.random.randint(1000, 10000, size=10)
